...
parse = function (buffer_org) {
  ...
  ret.datascaling = 
  {
    slope:scl_slope,
    offset:scl_inter,
    id: function() {return (scl_slope==1 & scl_inter==0) },
    e: function(v) { return v*scl_slope+scl_inter },
    ie: function (v) { return (v-scl_inter)/scl_slope }
  };
  ...
  else
  {
    ...
    ret.spaceDirections = [ [1,0,0],  [0,1,0],       [0,0,1]];
    ret.spaceOrigin = [ 0,0,0];
  }
  // TODO: Enforce that spaceDirections and so on have the correct size.


  // to avoid numerical problems in math.js
 // ret.spaceDirections = math.add(math.matrix(ret.spaceDirections),0.000000000001)._data; 
