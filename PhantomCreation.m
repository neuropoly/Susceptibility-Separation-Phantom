...
% Call the T2 simulation function
T2_simulation(seg_file, T2_star_file, M0_file, T2_uniform_file, R2_file);

%% 3T maps creation
% Define file paths
R2_file = 'data/maps/R2.nii.gz';
R2star_file = 'data/maps/R2star.nii.gz';
R1_file = 'data/maps/R1.nii.gz';
seg_file = 'data/masks/SegmentedModel.nii.gz';

% Call the 3T_simulation function
Map_creation_3T(R2_file, R2star_file, R1_file, seg_file);
